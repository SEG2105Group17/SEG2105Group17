...
public final class ActivityAdminLoginBinding implements ViewBinding {
  ...
  private ActivityAdminLoginBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView adminUsername, @NonNull Button btnBack2, @NonNull EditText editPasswordA,
  ...
  public static ActivityAdminLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnBack2;
      Button btnBack2 = ViewBindings.findChildViewById(rootView, id);
      if (btnBack2 == null) {
        break missingId;
      }
      ...
      return new ActivityAdminLoginBinding((ConstraintLayout) rootView, adminLoginBTN,
          adminPassword, adminTitle, adminUsername, btnBack2, editPasswordA, editUsernameA);
    }
