...
public final class ActivityMemberLoginBinding implements ViewBinding {
  ...
  private ActivityMemberLoginBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button adminLoginBTN, @NonNull TextView adminPassword, @NonNull TextView adminTitle,
      @NonNull TextView adminUsername, @NonNull Button btnBack4, @NonNull EditText editPasswordA,
  ...
  @NonNull
  public static ActivityMemberLoginBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMemberLoginBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_member_login, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMemberLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnBack4;
      Button btnBack4 = ViewBindings.findChildViewById(rootView, id);
      if (btnBack4 == null) {
        break missingId;
      }
      ...
      return new ActivityMemberLoginBinding((ConstraintLayout) rootView, adminLoginBTN,
          adminPassword, adminTitle, adminUsername, btnBack4, editPasswordA, editUsernameA);
    }
