...
public class MyDBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        //CREATE TABLE TABLE_PRODUCTS (COLUMN_ID INTEGER PRIMARY KEY, COLUMN_PRODUCTNAME TEXT, COLUMN_PRICE DOUBLE)
        String CREATE_PRODUCTS_TABLE = "CREATE TABLE " + TABLE_PRODUCTS
                + "(" + COLUMN_ID + "INETGER PRIMARY KEY, "
    ...
    //change tables by incrementing the batabase version number
    @Override
    ...
    public void addProduct(Product product){
        ...
        values.put(COLUMN_PRODUCTNAME, product.getProductName()); //get methods created from Product class
    ...
    public boolean deleteProduct(String productname){
        ...
        //this deletes the first accurance of the product with the specified name
        if(cursor.moveToFirst()){
